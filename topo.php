      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="conteudoNavbarSuportado">
                ...
                <div class="col-md-8 mx-auto  d-flex justify-content-center">    
                    <form method="GET" action="profissionais.php" id="procurar_profissional" class=" col-md-8 form-inline " >
                ...
                <div class=" d-flex justify-content-end  w-100">
                    ...
                    <ul class="navbar-nav ">
                        <li class="nav-item dropdown  ">
                            <!-- Se nome de usuario existir aparecera nome de usuario-->
                            <?php if ($nome_usuario) {
                       ...
                       <ul class="navbar-nav mr-3">
                        ...
                        <li class="nav-item ">
                            <?php if ($nome_usuario) { ?>
                                <a class="btn-sm text-white px-4 py-2 mx-sm-2 rounded-pill btn-orange " href="sair.php">Sair </a>
                            <?php } else {  ?>
                                <a class="btn-sm text-white px-4 py-2 mx-sm-2 rounded-pill btn-orange " href="login.php"> entrar</a> 
                            <?php } ?>
                        </li>
                    </ul>
                </div>
