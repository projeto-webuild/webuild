...
$con = new Conexao();
$link = $con->conecta();
// verificação para o campo pesquisa nao tiver vazio
...
$qtd_registro = "SELECT COUNT(*) as total_registro FROM usuario,endereco WHERE 1 = 1";
...
$sql = "SELECT u.img,u.id_usuario,u.nome,u.data_nascimento,u.profissao, e.cep,e.rua,e.bairro  FROM usuario as u left join endereco as e on(u.id_usuario = e.id_usuario) ";
...
<div class="container  p-5">
    ...
    if ($res) {
        ...
        while ($re = mysqli_fetch_assoc($res)) {
            ...
            <div class="row resultado shadow ">
                ...
                <div class="col-8 py-3  ">
                    ...
                    <a class="btn-sm text-white px-4 py-2 mx-sm-2 rounded-pill btn-orange " href="perfil.php?id=<?= $id_usuario ?>"> ver perfil </a>
        ...
        <nav class="d-flex justify-content-center">
            ...
            <ul class="pagination ">
                <li class="page-item">
                    <a class="page-link" href="?pesquisa=<?= $pesquisa ?>&btn_procurar=&pagina= <?= $pagina_atual - 1 ?>" aria-label="Anterior">
                ...
                <li class="page-item">
                    <a class="page-link" href="?pesquisa=<?= $pesquisa ?>&btn_procurar=&pagina= <?= $pagina_atual + 1 ?>" aria-label="Próximo">
